...
namespace WeatherApp
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        {
            InitializeComponent();
            cityButton.Clicked += async (s, e) =>
           {
              await GetWeatherInfo(cityTxt.Text);
           };
        }

       // private string Location = "Manchester";
       


        private async Task GetWeatherInfo(string cityName)
        {
            var url = $"https://api.openweathermap.org/data/2.5/weather?q={cityName}&appid=eb62434964b704087aa79443e0a62f0b&units=metric";

            var result = await APIStuff.GetWeather(url);
        ...
        {
            var url = $"https://api.openweathermap.org/data/2.5/forecast?q={cityTxt.Text}&appid=eb62434964b704087aa79443e0a62f0b&units=metric";
            var result = await APIStuff.GetWeather(url);
            ...
            if (result.Successful)
            {
                try
                {
                    ...
                    List<WeatherData.List> allList = new List<WeatherData.List>();
